(async function () {
  // Simulating fetch and data response
  const res = [
    {
      id: 1001,
      imageUrl: "gfg.png",
    ...
    },
    {
      ...
      firstName: "Gabriella",
      lastName: "Wilkinson",
      email: "Gabriella.Wilkinson@gfg.com",
